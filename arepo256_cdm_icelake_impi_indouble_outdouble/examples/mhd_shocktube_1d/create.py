...
def create_ics(path, filename='ics.hdf5'):
    ...
    Uthermal = np.full(NumberOfCells,
                       (pressure_L / density_L / gamma_minus_one),
                       dtype=FloatType)
    ...
    with h5py.File(FilePath, 'w') as IC:
        ## create hdf5 groups
...
if __name__ == '__main__':
    ...
    print('examples/mhd_shocktube_1d/create.py: creating ICs in directory ' +
