...
#define AMR_REFINE_EXPAND                                                                                                        \
  (AMR_REFINE_EXPAND_LEFT | AMR_REFINE_EXPAND_RIGHT | AMR_REFINE_EXPAND_FRONT | AMR_REFINE_EXPAND_BACK | AMR_REFINE_EXPAND_TOP | \
   AMR_REFINE_EXPAND_BOTTOM)
