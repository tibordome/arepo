...
static void min_max_mean_conserved_values_of_neighbours(double w0_left[4], double w0_right[4], double w0_back[4], double w0_front[4],
                                                        double w_max[4], double w_min[4])
{
  int k;
...
static double calculate_machnumber_T_jump(double T_jump)
{
  ...
  solve_quadratic_equation(2 * GAMMA * (GAMMA - 1), 4 * GAMMA - (GAMMA - 1) * (GAMMA - 1) - (GAMMA + 1) * (GAMMA + 1) * T_jump,
