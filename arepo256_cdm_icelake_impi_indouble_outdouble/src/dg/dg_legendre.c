...
double P_0(double x) { return 1; }

double P_1(double x) { return sqrt(3) * x; }
...
double dP_0(double x) { return 0; }

double dP_1(double x) { return sqrt(3.); }

double dP_2(double x) { return sqrt(5.) * 0.5 * 6. * x; }
 ...
 */
double scaled_Legendre(int n, double x) { return sqrt(2. * n + 1) * Legendre(n, x); }
...
double deriv_Legendre(int n, double x)
{
  if(n == 0)
    ...
    {
      return 1. / n *
             ((2. * n - 1) * Legendre(n - 1, x) + (2 * n - 1) * x * deriv_Legendre(n - 1, x) - (n - 1.) * deriv_Legendre(n - 2, x));
    }
}
 ...
 */
double deriv_scaled_Legendre(int n, double x) { return sqrt(2. * n + 1) * deriv_Legendre(n, x); }
 ...
 */
void ini_1d_quadrature_points(void)
{
  int i;
...
void delete_duplicated_union_quad_points(void)
{
#ifdef OLD_VERSION
  return;
#endif
  ...
  for(k = 0; k < Nof_union_quad_points; k++)
    {
      ...
      for(l = 0; l < Nof_union_quad_points_temp; l++)
        {
          if(Union_quad_points_x_temp[l] == GET_Union_quad_points_x(k) && Union_quad_points_y_temp[l] == GET_Union_quad_points_y(k) &&
             Union_quad_points_z_temp[l] == GET_Union_quad_points_z(k))
            {
              counter_duplicates++;
              duplicate = 1;

              mpi_fprintf(FdInfoDG, "Deleting duplicate union quadrature point (%f, %f, %f)\n", GET_Union_quad_points_x(k),
                          GET_Union_quad_points_y(k), GET_Union_quad_points_z(k));
            }
        }
  ...
  Union_base_values =
      (double(*)[NOF_BASE_FUNCTIONS])mymalloc("Union_base_values", Nof_base_functions * Nof_union_quad_points * sizeof(double));
 ...
 */
void ini_multi_d_quadrature_points(void)
{
  int i, j, k;
  ...
  for(i = 0; i < Nof_inner_quad_points; i++)
    {
      ...
      SET_Inner_quad_points_weights(i,
                                    GET_Quad_points_weights_1d(i % (DEGREE_K + 1)) * GET_Quad_points_weights_1d(i / (DEGREE_K + 1)));
    }
#else
  k = 0;
          ...
          for(l = 0; l < Nof_quad_points_1d; l++)
            {
              ...
              SET_Inner_quad_points_weights(
                  k, GET_Quad_points_weights_1d(i) * GET_Quad_points_weights_1d(j) * GET_Quad_points_weights_1d(l));
 ...
 */
void ini_base_function_values(void)
{
  int i, j;
  ...
  for(j = 0; j < Nof_union_quad_points; j++)
    {
      for(i = 0; i < Nof_base_functions; i++)
        {
          SET_Union_base_values(j, i,
                                base_function(i, GET_Union_quad_points_x(j), GET_Union_quad_points_y(j), GET_Union_quad_points_z(j)));
        }
    }
  ...
  for(j = 0; j < Nof_inner_quad_points; j++)
    {
      for(i = 0; i < Nof_base_functions; i++)
        {
          SET_Inner_base_values(j, i,
                                base_function(i, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_quad_points_z(j)));
          SET_Inner_base_dx_values(
              j, i, deriv_x_base_function(i, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_quad_points_z(j)));
          SET_Inner_base_dy_values(
              j, i, deriv_y_base_function(i, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_quad_points_z(j)));
#ifdef TWODIMS
          SET_Inner_base_dz_values(j, i, 0);
#else
          SET_Inner_base_dz_values(
              j, i, deriv_z_base_function(i, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_quad_points_z(j)));
#endif
        }
    }
      ...
      for(j = 0; j < Nof_outer_quad_points; j++)  // loop over outer quadrature points
        {
          for(i = 0; i < Nof_base_functions; i++)
            {
              SET_Outer_base_values(
                  k, j, i,
                  base_function(i, GET_Outer_quad_points_x(k, j), GET_Outer_quad_points_y(k, j), GET_Outer_quad_points_z(k, j)));
            }
        }
    }
 ...
 */
void ini_refinement_matrices(void)
{
  int j, l;
              ...
              for(v = 0; v < Nof_quad_points_1d; v++)
                {
                  ...
                  {
                    sum_a += base_function(j, (GET_Quad_points_1d(u) - 1) * 0.5, (GET_Quad_points_1d(v) - 1) * 0.5,
                                           (GET_Quad_points_1d(w) - 1) * 0.5) *
                    ...
                    sum_b += base_function(j, (GET_Quad_points_1d(u) + 1) * 0.5, (GET_Quad_points_1d(v) - 1) * 0.5,
                                           (GET_Quad_points_1d(w) - 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

                    sum_c += base_function(j, (GET_Quad_points_1d(u) - 1) * 0.5, (GET_Quad_points_1d(v) + 1) * 0.5,
                                           (GET_Quad_points_1d(w) - 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

                    sum_d += base_function(j, (GET_Quad_points_1d(u) + 1) * 0.5, (GET_Quad_points_1d(v) + 1) * 0.5,
                                           (GET_Quad_points_1d(w) - 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

#ifndef TWODIMS
                    sum_e += base_function(j, (GET_Quad_points_1d(u) - 1) * 0.5, (GET_Quad_points_1d(v) - 1) * 0.5,
                                           (GET_Quad_points_1d(w) + 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

                    sum_f += base_function(j, (GET_Quad_points_1d(u) + 1) * 0.5, (GET_Quad_points_1d(v) - 1) * 0.5,
                                           (GET_Quad_points_1d(w) + 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

                    sum_g += base_function(j, (GET_Quad_points_1d(u) - 1) * 0.5, (GET_Quad_points_1d(v) + 1) * 0.5,
                                           (GET_Quad_points_1d(w) + 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));

                    sum_h += base_function(j, (GET_Quad_points_1d(u) + 1) * 0.5, (GET_Quad_points_1d(v) + 1) * 0.5,
                                           (GET_Quad_points_1d(w) + 1) * 0.5) *
                             base_function(l, GET_Quad_points_1d(u), GET_Quad_points_1d(v), GET_Quad_points_1d(w)) *
                             GET_Quad_points_weights_1d(u) * GET_Quad_points_weights_1d(v) DG3D(*GET_Quad_points_weights_1d(w));
#endif
...
void print_quad_info(void)
{
  ...
  for(j = 0; j < Nof_inner_quad_points; j++)
    {
#ifdef TWODIMS
      mpi_fprintf(FdInfoDG, "x=%f\ty=%f\tw=%f\n", GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j),
                  GET_Inner_quad_points_weights(j));
#else
      mpi_fprintf(FdInfoDG, "x=%f\ty=%f\tz=%f\tw=%f\n", GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j),
                  GET_Inner_quad_points_z(j), GET_Inner_quad_points_weights(j));
#endif
    }
  ...
  for(i = 0; i < Nof_interfaces; i++)
    {
      for(j = 0; j < Nof_outer_quad_points; j++)
        {
#ifdef TWODIMS
          mpi_fprintf(FdInfoDG, "x=%f\ty=%f\tw=%f\n", GET_Outer_quad_points_x(i, j), GET_Outer_quad_points_y(i, j),
                      GET_Outer_quad_points_weights(i, j));
#else
          mpi_fprintf(FdInfoDG, "x=%f\ty=%f\tz=%f\tw=%f\n", GET_Outer_quad_points_x(i, j), GET_Outer_quad_points_y(i, j),
                      GET_Outer_quad_points_z(i, j), GET_Outer_quad_points_weights(i, j));
#endif
        }
    }
}
      ...
      for(i = 0; i < Nof_base_functions; i++)
        {
          ...
          mpi_fprintf(FdInfoDG, "base function: %d: P%d(x)*P%d(y), quad_point: (%f, %f), value: %f\n", i, Px, Py,
                      GET_Union_quad_points_x(j), GET_Union_quad_points_y(j), GET_Union_base_values(j, i));
#else
          mpi_fprintf(FdInfoDG, "base function: %d: P%d(x)*P%d(y)*P%d(z), quad_point: (%f, %f, %f), value: %f\n", i, Px, Py, Pz,
                      GET_Union_quad_points_x(j), GET_Union_quad_points_y(j), GET_Union_quad_points_z(j), GET_Union_base_values(j, i));
#endif
        }
    }
      ...
      for(i = 0; i < Nof_base_functions; i++)
        {
          ...
          mpi_fprintf(FdInfoDG, "base function: %d: P%d(x)*P%d(y), quad_point: (%f, %f), value: %f, d/dx value: %f, d/dy value: %f\n",
                      i, Px, Py, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_base_values(j, i),
                      GET_Inner_base_dx_values(j, i), GET_Inner_base_dy_values(j, i));
#else
          mpi_fprintf(FdInfoDG,
                      "base function: %d: P%d(x)*P%d(y)*P%d(z), quad_point: (%f, %f, %f), value: %f, d/dx value: %f, d/dy value: %f, "
                      "d/dz value: %f\n",
                      i, Px, Py, Pz, GET_Inner_quad_points_x(j), GET_Inner_quad_points_y(j), GET_Inner_quad_points_z(j),
                      GET_Inner_base_values(j, i), GET_Inner_base_dx_values(j, i), GET_Inner_base_dy_values(j, i),
                      GET_Inner_base_dz_values(j, i));
#endif
        }
    }
...
#ifdef TWODIMS
              mpi_fprintf(FdInfoDG, "base function: %d: P%d(x)*P%d(y), quad_point: (%f, %f), value: %f\n", i, Px, Py,
                          GET_Outer_quad_points_x(k, j), GET_Outer_quad_points_y(k, j), GET_Outer_base_values(k, j, i));
#else
              mpi_fprintf(FdInfoDG, "base function: %d: P%d(x)*P%d(y)*P%d(z), quad_point: (%f, %f, %f), value: %f\n", i, Px, Py, Pz,
                          GET_Outer_quad_points_x(k, j), GET_Outer_quad_points_y(k, j), GET_Outer_quad_points_z(k, j),
                          GET_Outer_base_values(k, j, i));
#endif
            }
        }
    }
 ...
 */
void print_ref_matrix_info(void)
{
