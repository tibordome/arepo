...
#error SMUGGLE_TEST_SFR requires COOLING and USE_SFR enabled
#endif
...
void test_sfr_eEOS(void)
{
  ...
  sprintf(All.CoolingTablePath, "%s",
          "./data/Arepo_GFM_Tables/Cooling/"
          "cooling_metal_AGN_Compton_self_"
          "shielding_Rahmati12.hdf5");
#endif
...
#if !defined(COOLING) && !defined(SMUGGLE_SFR)
#error SMUGGLE_TEST_SFR requires COOLING and SMUGGLE_SFR enabled
#endif
