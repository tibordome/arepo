...
void healray_split(void);
void healray_advance(void);
  ...
  if(do_ray_step)
    {
      ...
      dt_rest = fmax(dt_sum - (dt_init + dt_advance + dt_comm + dt_imba), 0.);
#ifndef TGCHEM
      ...
      mpi_printf("HEALRAY: Done! %d loops, %d iterations, %g rays, %g operations, (%g/%g) advances/comms per ray\n", HRD.Loop + 1,
                 tot_iter, (double)HRD.TotInitNumRays, (double)HRD.NumOps, HRD.AdvancesPerRay, HRD.CommsPerRay);
      mpi_printf("HEALRAY: Ray Imbalance: %g, Init: %g, Advance: %g, Imba: %g, Comm: %g, Rest: %g, Total: %g seconds\n\n", avg_imba,
                 dt_init, dt_advance, dt_imba, dt_comm, dt_rest, dt_sum);
#ifndef TGCHEM
      if(!HRD.RayTimeFac)
        {
          produce_dump();
  ...
  while(glob_flag)
    {
      ...
      HRD.TmpRayEnergyLine =
          mymalloc_movable(&HRD.TmpRayEnergyLine, "TmpRayEnergyLine", HRD.TmpMaxNumRays * HRD.RayNumLines * sizeof(double));
      HRD.TmpRayEnergyLineInit =
          mymalloc_movable(&HRD.TmpRayEnergyLineInit, "TmpRayEnergyLineInit", HRD.TmpMaxNumRays * HRD.RayNumLines * sizeof(double));
              ...
              if(HRD.TmpNumRays + 4 > HRD.TmpMaxNumRays)
                {
                  ...
                  HRD.TmpRayEnergyLineInit =
                      myrealloc_movable(HRD.TmpRayEnergyLineInit, HRD.TmpMaxNumRays * HRD.RayNumLines * sizeof(double));
              ...
              for(j = 0; j < 4; j++)
                {
                  ...
                  memcpy(HRD.TmpRayEnergyLine + HRD.TmpNumRays * HRD.RayNumLines, HRD.RayEnergyLine + i * HRD.RayNumLines,
                         HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.TmpRayEnergyLineInit + HRD.TmpNumRays * HRD.RayNumLines, HRD.RayEnergyLineInit + i * HRD.RayNumLines,
                         HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.TmpRayEnergy + HRD.TmpNumRays * HRD.RayNumBins, HRD.RayEnergy + i * HRD.RayNumBins,
                         HRD.RayNumBins * sizeof(float));
                  ...
                  for(k = 0; k < 3; k++)
                    {
                      ...
                      HRD.TmpHRRD[HRD.TmpNumRays].pos[k] =
                          HRD.HRRD[i].pos[k] + HRD.HRRD[i].len * (HRD.TmpHRRD[HRD.TmpNumRays].dir[k] - HRD.HRRD[i].dir[k]);
                    }
                  ...
                  for(k = 0; k < HRD.RayNumLines; k++)
                    {
                      ...
                      HRD.TmpRayEnergyLineInit[HRD.TmpNumRays * HRD.RayNumLines + k] =
                          HRD.RayEnergyLineInit[i * HRD.RayNumLines + k] / 4.;
                    }
              ...
              if(i != HRD.NumRays - 1)
                {
                  ...
                  memcpy(HRD.RayEnergyLine + i * HRD.RayNumLines, HRD.RayEnergyLine + (HRD.NumRays - 1) * HRD.RayNumLines,
                         HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.RayEnergyLineInit + i * HRD.RayNumLines, HRD.RayEnergyLineInit + (HRD.NumRays - 1) * HRD.RayNumLines,
                         HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.RayEnergy + i * HRD.RayNumBins, HRD.RayEnergy + (HRD.NumRays - 1) * HRD.RayNumBins,
                         HRD.RayNumBins * sizeof(float));
                }
      ...
      for(i = 0; i < HRD.TmpNumRays; i++)
        {
          ...
          if(fabs(P[idx].Pos[0] - HRD.TmpHRRD[i].pos_old[0]) > boxHalf_X)
            rmray_flag = 1;

          if(fabs(P[idx].Pos[1] - HRD.TmpHRRD[i].pos_old[1]) > boxHalf_Y)
            rmray_flag = 1;

          if(fabs(P[idx].Pos[2] - HRD.TmpHRRD[i].pos_old[2]) > boxHalf_Z)
            rmray_flag = 1;
              ...
              if(i != HRD.TmpNumRays - 1)
                {
                  ...
                  memcpy(HRD.TmpRayEnergyLine + i * HRD.RayNumLines, HRD.TmpRayEnergyLine + (HRD.TmpNumRays - 1) * HRD.RayNumLines,
                         HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.TmpRayEnergyLineInit + i * HRD.RayNumLines,
                         HRD.TmpRayEnergyLineInit + (HRD.TmpNumRays - 1) * HRD.RayNumLines, HRD.RayNumLines * sizeof(double));
                  memcpy(HRD.TmpRayEnergy + i * HRD.RayNumBins, HRD.TmpRayEnergy + (HRD.TmpNumRays - 1) * HRD.RayNumBins,
                         HRD.RayNumBins * sizeof(float));
                }
      ...
      if(!HRD.RayMode)
        {
          mpi_distribute_items_to_tasks(HRD.EscFrac, offsetof(struct EscFrac_struct, task), &HRD.NumEscFrac, &HRD.MaxNumEscFrac,
                                        sizeof(struct EscFrac_struct), TAG_DENS_A);
      ...
      if(HRD.TmpNumRays)
        {
          ...
          memcpy(HRD.RayEnergyLine + HRD.NumRays * HRD.RayNumLines, HRD.TmpRayEnergyLine,
                 HRD.TmpNumRays * HRD.RayNumLines * sizeof(double));
          memcpy(HRD.RayEnergyLineInit + HRD.NumRays * HRD.RayNumLines, HRD.TmpRayEnergyLineInit,
                 HRD.TmpNumRays * HRD.RayNumLines * sizeof(double));
                ...
                if(HRD.RayMultiFreqMode)
                  {
                    ...
                    if(HRD.RayDebugMode)
                      {
                        printf("reduc: %g %g %g %g %g %g %d %g %d %g %g %g %g\n", nh, abh2, len, HRD.LenToCgs, fac,
                               HRD.HRRD[i].temp_init, temp_idx_orig, temp, temp_idx, dtemp, shift_temp, vrel, shift_vrel);
                        ...
                        for(j = 0; j < HRD.RayNumLines; j++)
                          {
                            ...
                            printf("reduc line: %d %d %g %g %g %g %g %g %g\n", j,
                                   TGCD.H2LineIdxTable[j * TGCHEM_NUM_TEMP + temp_idx_orig], TotEmiss, TGCD.H2EmissTable[tidx],
                                   Emiss[j], TotCross, TGCD.H2CrossTable[tidx], Cross[j], ReducExp[j]);
                          }
                        ...
                        for(j = l = 0; j < HRD.RayNumLines; j++)
                          {
                            ...
                            printf("reduc absorption: %d %g\n", j,
                                   HRD.RayEnergyLine[i * HRD.RayNumLines + j] / HRD.RayEnergyLineInit[i * HRD.RayNumLines + j]);
                          }
                      }
                    ...
                    denergy = fmax(HRD.HRRD[i].energy - new_energy, 0.);
                  }
                else
        ...
        if(HRD.RayDebugMode && rmray_flag)
          {
            ...
            if(!TGCD.ChemMode)
              {
                printf("absorption: %d %d %g %g %g %g %g %g %g %g %d %g %g %g %g %g %g %g\n", HRD.HRRD[i].idx_orig, HRD.HRRD[i].idx,
                       nh, HRD.LenToCgs * len, fac, abh2, abhii, mu, temp, dtemp, temp_idx, TotEmiss, TotCross, fac * TotCross,
                       HRD.HRRD[i].energy_init, denergy, HRD.HRRD[i].energy, HRD.HRRD[i].energy / HRD.HRRD[i].energy_init);
...
#else
            printf("absorption: %d %g %g %g %g %g\n", HRD.HRRD[i].idx_orig, HRD.Alpha, HRD.LenToCgs * len, HRD.HRRD[i].energy_init,
                   denergy, HRD.HRRD[i].energy / HRD.HRRD[i].energy_init);
#endif
          }
            ...
            if(i != HRD.ThreadPrevNumRays[tid] + HRD.ThreadNumRays[tid] - 1)
              {
                ...
                memcpy(HRD.RayEnergyLine + i * HRD.RayNumLines, HRD.RayEnergyLine + last_idx * HRD.RayNumLines,
                       HRD.RayNumLines * sizeof(double));
                memcpy(HRD.RayEnergyLineInit + i * HRD.RayNumLines, HRD.RayEnergyLineInit + last_idx * HRD.RayNumLines,
                       HRD.RayNumLines * sizeof(double));
  ...
  for(i = HRD.NumRays = 0; i < HRD.RayNumThreads; i++)
    {
      ...
      memmove(HRD.RayEnergyLine + HRD.NumRays * HRD.RayNumLines, HRD.RayEnergyLine + HRD.ThreadPrevNumRays[i] * HRD.RayNumLines,
              HRD.ThreadNumRays[i] * HRD.RayNumLines * sizeof(double));
      memmove(HRD.RayEnergyLineInit + HRD.NumRays * HRD.RayNumLines,
              HRD.RayEnergyLineInit + HRD.ThreadPrevNumRays[i] * HRD.RayNumLines,
              HRD.ThreadNumRays[i] * HRD.RayNumLines * sizeof(double));
      memmove(HRD.RayEnergy + HRD.NumRays * HRD.RayNumBins, HRD.RayEnergy + HRD.ThreadPrevNumRays[i] * HRD.RayNumBins,
              HRD.ThreadNumRays[i] * HRD.RayNumBins * sizeof(float));
