...
void dg_compute_step(void)
{
  ...
  double(*_mRdt)[NumGas][NOF_BASE_FUNCTIONS][5] =
      (double(*)[NumGas][NOF_BASE_FUNCTIONS][5])mymalloc("a2", NumGas * _rk_stages * Nof_base_functions * 5 * sizeof(double));
  double(*w0)[NOF_BASE_FUNCTIONS][5] =
      (double(*)[NOF_BASE_FUNCTIONS][5])mymalloc("w0", NumGas * Nof_base_functions * 5 * sizeof(double));
  double(*w_temp)[NOF_BASE_FUNCTIONS][5] =
      (double(*)[NOF_BASE_FUNCTIONS][5])mymalloc("w0", NumGas * Nof_base_functions * 5 * sizeof(double));
