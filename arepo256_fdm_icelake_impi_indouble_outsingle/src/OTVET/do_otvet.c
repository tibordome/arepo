...
int do_otvet(void)
{
  ...
  mpi_printf("SMUGGLE_RADPRESS_OPT_THICK: starting...\n");
  radpressthick();
  mpi_printf("SMUGGLE_RADPRESS_OPT_THICK: done.\n");
#endif

#ifdef SMUGGLE_RADPRESS_OPT_THIN
  mpi_printf("SMUGGLE_RADPRESS_OPT_THIN: starting...\n");
  radpressthin();
  mpi_printf("SMUGGLE_RADPRESS_OPT_THIN: done.\n");
#endif
