              ...
              if(k >= All.StKmin && k <= All.StKmax)
                {
                  if(All.StSpectForm == 0)
                    ...
                    {
                      ampl =
                          4.0 * (amin - 1.0) / ((All.StKmax - All.StKmin) * (All.StKmax - All.StKmin)) * ((k - kc) * (k - kc)) + 1.0;
                    }
          ...
          for(i = 0; i < NumGas; i++)
            {
              ...
              SphP[i].SgsTData.DuDt_Adiab = SphP[i].SgsTData.EgyAdiab / P[i].Mass / delta;
              SphP[i].SgsTData.EgyAdiab   = 0;

              SphP[i].SgsTData.DuDt_TurbProd = SphP[i].SgsTData.EgyTurbProd / P[i].Mass / delta;
              SphP[i].SgsTData.EgyTurbProd   = 0;

              SphP[i].SgsTData.DuDt_ViscDiss = SphP[i].SgsTData.EgyViscDiss / P[i].Mass / delta;
              SphP[i].SgsTData.EgyViscDiss   = 0;
#endif
          ...
          for(j = 0; j < 3; j++)
            {
              ...
              if(All.Time > All.TimeTurbDecay)
                SphP[i].TurbAccel[j] = 0;
              else
