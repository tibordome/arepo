...
if(ThisTask == 0 && All.Dust_Destruction_Tau != all.Dust_Destruction_Tau)
  ...
  if(ThisTask == 0 && All.SNEScatterAroundSink != all.SNEScatterAroundSink)
    warn("SNEScatterAroundSink modified from %g to %g while restarting at Time=%g", All.SNEScatterAroundSink, all.SNEScatterAroundSink, All.Time);
  ...
  if(ThisTask == 0 && All.SINKStarFormationEfficiency != all.SINKStarFormationEfficiency)
    warn("SINKStarFormationEfficiency modified from %g to %g while restarting at Time=%g", All.SINKStarFormationEfficiency, all.SINKStarFormationEfficiency, All.Time);
