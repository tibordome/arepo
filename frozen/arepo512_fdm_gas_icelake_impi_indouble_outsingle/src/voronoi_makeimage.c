...
#if CHEMISTRYNETWORK == 15
  xCHX = mymalloc("CHX", pixels_y * pixels_z * sizeof(float));
  xOHX = mymalloc("OHX", pixels_y * pixels_z * sizeof(float));
  xHCOP = mymalloc("HCOP", pixels_y * pixels_z * sizeof(float));
  xCP = mymalloc("CP", pixels_y * pixels_z * sizeof(float));
  xMP = mymalloc("MP", pixels_y * pixels_z * sizeof(float));
  xHEP = mymalloc("HEP", pixels_y * pixels_z * sizeof(float));
#endif
#endif
...
#if CHEMISTRYNETWORK == 15
  CHX = mymalloc("CHX", pixels_x * pixels_y * sizeof(float));
  OHX = mymalloc("OHX", pixels_x * pixels_y * sizeof(float));
  HCOP = mymalloc("HCOP", pixels_x * pixels_y * sizeof(float));
  CP = mymalloc("CP", pixels_x * pixels_y * sizeof(float));
  MP = mymalloc("MP", pixels_x * pixels_y * sizeof(float));
  HEP = mymalloc("HEP", pixels_x * pixels_y * sizeof(float));
#endif
#endif
      ...
      if(Bfield)
        {
          ...
          if(gradients_flag == 1)
            {
              mag_x = SphP[sph_idx].B[0] + SphP[sph_idx].Grad.dB[0][0] * l_dx + SphP[sph_idx].Grad.dB[0][1] * l_dy + SphP[sph_idx].Grad.dB[0][2] * l_dz;
              mag_y = SphP[sph_idx].B[1] + SphP[sph_idx].Grad.dB[1][0] * l_dx + SphP[sph_idx].Grad.dB[1][1] * l_dy + SphP[sph_idx].Grad.dB[1][2] * l_dz;
              mag_z = SphP[sph_idx].B[2] + SphP[sph_idx].Grad.dB[2][0] * l_dx + SphP[sph_idx].Grad.dB[2][1] * l_dy + SphP[sph_idx].Grad.dB[2][2] * l_dz;
            }
          else
            {
