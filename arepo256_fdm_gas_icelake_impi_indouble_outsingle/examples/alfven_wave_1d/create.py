...
def create_ics(path, filename='ics.hdf5'):
    ...
    # conversion Lorentz System->Gaussian System
    part0.create_dataset("MagneticField", data=Bfield*np.sqrt(4*np.pi))
...
if __name__ == '__main__':
    ...
    print("examples/alfven_wave_1d/create.py: creating ICs in directory " +
