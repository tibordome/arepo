...
void healray_merge(void)
{
  ...
  // for(i = 0; i < HRD.NumRays; i++)
  // printf("ray 2: %d %d %d %d %d %d\n", ThisTask, HRD.HRRD[i].idx, HRD.HRRD[i].lvl, HRD.HRRD[i].hpidx, HRD.HRRD[i].hpidx_orig,
  // HRD.HRRD[i].iter);
  ...
  /*
     ...
     mpi_printf("match 1: %d %d %d %d %d %d %g %g %g\n", ThisTask, HRD.HRRD[i].task, HRD.HRRD[i].id, HRD.HRRD[i].hpidx,
     HRD.HRRD[i].iter, HRD.HRRD[i].idx, HRD.HRRD[i].dir[0], HRD.HRRD[i].dir[1], HRD.HRRD[i].dir[2]);

     mpi_printf("match 2: %d %d %d %d %d %d %g %g %g\n", ThisTask, HRD.HRRD[j].task, HRD.HRRD[j].id, HRD.HRRD[j].hpidx,
     HRD.HRRD[j].iter, HRD.HRRD[j].idx, HRD.HRRD[j].dir[0], HRD.HRRD[j].dir[1], HRD.HRRD[j].dir[2]);
  ...
  /*
     ...
     mpi_distribute_items_from_search(searchdata, HRD.HRRD, &HRD.NumRays, &HRD.MaxNumRays, sizeof(struct HRRD_struct), TAG_DENS_A,
     offsetof(struct HRRD_struct, task), offsetof(struct HRRD_struct, idx));
