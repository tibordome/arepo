...
MyFloat get_CoolingMetalRate(MyFloat log_Metallicity, MyFloat log_HydrogenNumberDensity, MyFloat log_Temperature, MyFloat *cool_val,
                             MyFloat *lower_cool, MyFloat *upper_cool, MyFloat *lower_logT, MyFloat *upper_logT);
#else
