...
static double cell_density(int cell, double x, double y, double z) { return ic_density(x, y, z); }

static double cell_mom_x_density(int cell, double x, double y, double z) { return ic_density(x, y, z) * ic_velocity_x(x, y, z); }

static double cell_mom_y_density(int cell, double x, double y, double z) { return ic_density(x, y, z) * ic_velocity_y(x, y, z); }

static double cell_mom_z_density(int cell, double x, double y, double z) { return ic_density(x, y, z) * ic_velocity_z(x, y, z); }
...
void arepo_set_initial_conditions(void)
{
...
double ic_velocity_y(double x, double y, double z) { return 0; }

double ic_velocity_z(double x, double y, double z) { return 0; }
...
static double ic_density_old(double x, double y, double z) { return rho0 * (1. + A * sin(K * x)); }
...
double ic_pressure(double x, double y, double z) { return p0 * pow(ic_density(x, y, z) / rho0, GAMMA); }

double ic_density(double x, double y, double z) { return rho0 * (1. + A * sin(2 * M_PI * x)); }
...
double ic_pressure(double x, double y, double z) { return 2.5; }
...
double ic_velocity_y(double x, double y, double z)
{
  ...
  return omega * sin(4 * M_PI * x) *
         (exp(-(y - (0.25 + offset)) * (y - (0.25 + offset)) * 0.5 / (sigma * sigma)) +
          exp(-(y - (0.75 + offset)) * (y - (0.75 + offset)) * 0.5 / (sigma * sigma)));
}
...
double ic_density(double x, double y, double z) { return 1; }

double ic_velocity_x(double x, double y, double z) { return 0; }
...
double ic_pressure(double x, double y, double z) { return pow(ic_density(x, y, z), GAMMA); }
...
double ic_pressure(double x, double y, double z) { return 1; }

double ic_density(double x, double y, double z) { return 4 * x * x + 5; }
...
double ic_pressure(double x, double y, double z) { return 1e-6; }
...
static double dg_acceleration_z(double x, double y, double z) { return 0; }
...
double ic_velocity_x(double x, double y, double z) { return 100; }

double ic_velocity_y(double x, double y, double z) { return 50; }
...
double ic_pressure(double x, double y, double z) { return ic_density(x, y, z) * All.IsoSoundSpeed * All.IsoSoundSpeed; }
