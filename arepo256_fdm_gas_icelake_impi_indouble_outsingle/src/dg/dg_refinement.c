 ...
 * \param sun_num The position of the subnode (0: back left, 1: back right, 2: front left, 3: front right, 4: top back left, 5: top
 * back right, 6: top front left, 7: top front right) \param sun_index the particle index of the subnode
 */
