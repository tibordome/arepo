...
## examples/OrszagTang/OrszagTang_LabFrameExtrapolation_2d/Config.sh
## config file for 2d OrszagTang decaying turbulence MHD problem

FINITE_VOLUME_EXTRAPOLATION_IN_LABFRAME  # do time and spatial extrapolation in labframe -> not recommended in general, but tested explicitly here
