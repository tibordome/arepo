...
#ifdef USE_SFR
#if !defined(SMUGGLE_SFR) && !defined(LOCAL_FEEDBACK) && !defined(QUICK_LYALPHA)
...
void shock_finder_free_storage(void);
void shock_finder_arepo(void);
void shock_finder_ryu(void);
void shock_finder_skillman(void);
