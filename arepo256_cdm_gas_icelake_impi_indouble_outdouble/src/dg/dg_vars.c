...
const int Nof_outer_fine_quad_points =
    NOF_OUTER_FINE_QUAD_POINTS;                    /*!< number of fine quadrature points per interface for AMR boundary cells */
...
double (*Union_base_values)[NOF_BASE_FUNCTIONS]; /*! < 2d array [union point][base function]: values of the base functions at the union
                                                    points */
...
double (*Outer_quad_points_x)[NOF_OUTER_QUAD_POINTS]; /*!< 2d array [interface][quad point]: the x-coordinates of the outer quadrature
                                                         points */
double (*Outer_quad_points_y)[NOF_OUTER_QUAD_POINTS]; /*!< 2d array [interface][quad point]: the y-coordinates of the outer quadrature
                                                         points */
double (*Outer_quad_points_z)[NOF_OUTER_QUAD_POINTS]; /*!< 2d array [interface][quad point]: the z-coordinates of the outer quadrature
                                                         points */
double (*Outer_quad_points_weights)[NOF_OUTER_QUAD_POINTS]; /*!< 2d array [interface][quad point]: the quadrature weights of the outer
                                                               quadrature points */

double (*Inner_base_values)[NOF_BASE_FUNCTIONS];    /*!< 2d array [quad point][base function]: values of the base functions at the
                                                       quadrature points */
double (*Inner_base_dx_values)[NOF_BASE_FUNCTIONS]; /*!< 2d array [quad point][base function]: values of the x-derivative of the base
                                                       functions at the quadrature points */
double (*Inner_base_dy_values)[NOF_BASE_FUNCTIONS]; /*!< 2d array [quad point][base function]: values of the y-derivative of the base
                                                       functions at the quadrature points */
double (*Inner_base_dz_values)[NOF_BASE_FUNCTIONS]; /*!< 2d array [quad point][base function]: values of the z-derivative of the base
                                                       functions at the quadrature points */

double (*Outer_base_values)[NOF_OUTER_QUAD_POINTS][NOF_BASE_FUNCTIONS]; /*!< 3d array [interface][quad point][base function]: values of
                                                                           the base functions at the interface quadrature points */
double (*Outer_fine_base_values)[NOF_OUTER_FINE_QUAD_POINTS]
                                [NOF_BASE_FUNCTIONS]; /*!< 3d array [interface][fine quad point][base function]: values of the base
                                                         functions at the interface part quadrature points */
