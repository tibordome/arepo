...
void fld_restrict(int level)
{
  ...
  while(node >= 0)
    {
#ifdef TWODIMS
      Ngb_Nodes[node].hydro.b =
          1. / 4. * fld_resval(Ngb_Nodes[node].u.suns[2]) +
          1. / 8. *
              (fld_resval(Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].u.suns[3]) +
               fld_resval(Ngb_Nodes[Ngb_Nodes[node].neighbors[3]].u.suns[0]) + fld_resval(Ngb_Nodes[node].u.suns[0]) +
               fld_resval(Ngb_Nodes[node].u.suns[3])) +
          1. / 16. *
              (fld_resval(Ngb_Nodes[Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].neighbors[3]].u.suns[1]) +
               fld_resval(Ngb_Nodes[Ngb_Nodes[node].neighbors[3]].u.suns[1]) +
               fld_resval(Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].u.suns[1]) + fld_resval(Ngb_Nodes[node].u.suns[1]));

      Ngb_Nodes[node].hydro.kappa =
          1. / 4. * fld_reskappa(Ngb_Nodes[node].u.suns[2]) +
          1. / 8. *
              (fld_reskappa(Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].u.suns[3]) +
               fld_reskappa(Ngb_Nodes[Ngb_Nodes[node].neighbors[3]].u.suns[0]) + fld_reskappa(Ngb_Nodes[node].u.suns[0]) +
               fld_reskappa(Ngb_Nodes[node].u.suns[3])) +
          1. / 16. *
              (fld_reskappa(Ngb_Nodes[Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].neighbors[3]].u.suns[1]) +
...
#else
      Ngb_Nodes[node].hydro.b =
          1. / 2. * fld_resval(Ngb_Nodes[node].u.suns[0]) +
          1. / 4. * (fld_resval(Ngb_Nodes[Ngb_Nodes[node].neighbors[0]].u.suns[1]) + fld_resval(Ngb_Nodes[node].u.suns[1]));
