 ...
 *
 * \file        src/mhd_nonideal/implicit_ohmic_diffusion_cn.c
 * \date        10/2017
...
/*
 * ! \file implicit_ohmic_diffusion_cn.c
...
void init_ohm_conductivity(void) { mpi_printf("NON-IDEAL MHD: Conductivity set to %g (int units)\n", All.OhmicDiffusionCoefficient); }
...
#endif /* REFLECTIVE_X REFLECTIVE_Y REFLECTIVE_Z */
