 ...
 *
 * \file        src/mhd_nonideal/ambipolar_diffusion.c
 * \date        04/2016
 * \author      Federico Marinacci and Mark Vogelsberger
 * \brief
 * \details
 *
 *
                               ...
                               double sqrtatime)
{
  ...
  flux->energy +=
      All.AmbipolarDiffusionCoefficient * Bnormsq * (erg_flux[0] * geom->nx + erg_flux[1] * geom->ny + erg_flux[2] * geom->nz);
}
#endif
