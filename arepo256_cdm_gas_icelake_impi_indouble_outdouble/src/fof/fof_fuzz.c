...
void fof_get_group_fuzz_offsets(void)
{
  ...
  list_typeNumPart  = (int *)mymalloc("list_typeNumPart", NTask * sizeof(int));
  typeNumPartOffset = (long long *)mymalloc("typeNumPartOffset", NTask * sizeof(long long));

  list_min_keys = (long long *)mymalloc("list_min_keys", NTask * sizeof(long long));
  list_max_keys = (long long *)mymalloc("list_max_keys", NTask * sizeof(long long));
