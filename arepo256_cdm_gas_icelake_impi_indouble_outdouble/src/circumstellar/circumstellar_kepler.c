  ...
  while(1)
    {
      ...
      delta2 = -(ecc_anomaly - ecc * sin(ecc_anomaly) - mean_anomaly) /
               (1 - ecc * cos(ecc_anomaly) + 0.5 * delta1 * ecc * sin(ecc_anomaly));
      delta3 = -(ecc_anomaly - ecc * sin(ecc_anomaly) - mean_anomaly) /
               (1 - ecc * cos(ecc_anomaly) + 0.5 * delta2 * ecc * sin(ecc_anomaly) + delta2 * delta2 * ecc * cos(ecc_anomaly) / 6);
