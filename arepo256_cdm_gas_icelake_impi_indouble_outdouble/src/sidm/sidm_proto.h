...
void sidm_set_velocities(scatter_process_data_in *sprdata_in, scatter_process_data_out *sprdata_out, double dvabs_in,
                         double restitution, double *vcm_in, double *xunit);
