...
/* general, amr.c */
void amr_init(void);
int amr_check_domain_decomposition(void);
void amr_update_oldMass(void);
...
void amr_update_primitive_variables_nodes(void);
void amr_exchange_primitive_variables(void);
void amr_calculate_gradients(void);
void amr_exchange_primitive_variables_and_gradients(void);

/* mesh generation, amr_mesh.c */
void create_mesh(void);

void amr_initmesh(void);
...
void amr_validate_lists(void);

void amr_generate_gas_in_ics(void);
