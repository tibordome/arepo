# -*- coding: utf-8 -*-
#
# Arepo documentation build configuration file, created by sphinx-quickstart.
# To build documentation locally:
#   doxygen
##  sphinx-apidoc -o doxygen/sphinx_apidoc doxygen/xml
...
# ones.
breathe_projects = {"arepo": "../doxygen/xml"}
breathe_default_project = "arepo"
...
exhale_args = {
    ...
    "containmentFolder": "./ref",
    "rootFileName": "library_root.rst",
    "rootFileTitle": "Arepo Code Reference",
...
project = u'Arepo'
copyright = u'2016, Volker Springel et al.'
author = u'Volker Springel et al.'
...
version = u'' + git_version()
# The full version, including alpha/beta/rc tags.
release = u'' + git_version()
...
latex_documents = [
    (master_doc, 'Arepo.tex', u'AREPO Documentation',
     u'Volker Springel et al.', 'manual'),
]
...
man_pages = [(master_doc, 'arepo', u'Arepo Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'Arepo', u'Arepo Documentation', author, 'Arepo',
